    ...
    html! {
        <>
            ...
            <div class={ "section" }>
                ...
                The game also takes a lot of inspiration from source-engine FPS games like Half Life and Team Fortress 2, bearing similar expressive movement mechanics and
